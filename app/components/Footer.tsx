  ...
  return (
    <footer className="footer footer-center p-1 text-base-content rounded bg-[url('/footer-bg.png')] pt-[150px] pb-[50px] bg-center bg-cover">
      <nav className="grid grid-flow-col gap-4">
        ...
        <Link href={"/vision"} className="link link-hover">
          Vision
        </Link>
      ...
      <div className="flex flex-col md:flex-row-reverse w-[90%] m-auto justify-between">
        ...
        <nav>
          <div className="grid grid-flow-col gap-4">
            <a href="https://twitter.com/skct__official" target="blank">
              <svg
            ...
            <a href="https://www.facebook.com/skctofficial/" target="blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
        ...
        <div className="mt-[20px] bg-white p-2 rounded-xl lg:mt-0">
